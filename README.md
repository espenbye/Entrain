...
Sources/
  ...
  Adaptive/  Inputs that shape the sound while it plays: the daylight arc, the sun behind it and the suggested mode
...
Tests/       Loudness, synth, session and Health-reduction tests (Swift Testing, run on macOS)
Tools/
